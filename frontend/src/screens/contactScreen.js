              ...
              <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    name="full_name"
                    type="text"
                    className="focus:outline-none focus:border focus:border-blue-400 font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                    placeholder
                  />
                </div>
              </div>
            ...
            <div className="w-full mt-6">
              <div className="flex flex-col">
                ...
                <textarea
                  placeholder
                  name="message"
                  className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 focus:border focus:border-blue-400"
                  rows={8}
                  id="message"
                  defaultValue={""}
                />
              ...
              <button
                type="submit"
                className="focus:outline-none bg-gray-700 transition duration-150 ease-in-out hover:bg-blue-400 rounded text-white px-8 py-3 text-lg leading-6"
              >
                Submit
              </button>
            </div>
